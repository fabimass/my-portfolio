...
from portafolio.styles.styles import BASE_STYLE, MAX_WIDTH, THEME_COLOR, STYLESHEETS, EmSize, Size
...
def index() -> rx.Component:
    return rx.center(
        ...
        rx.vstack(
            ...
            info("Proyects", DATA.projects),
            info("Education", DATA.education),
            info("Certifications", DATA.certifications),
            #extra(DATA.extras),
            rx.divider(),
            footer(DATA.media),
